...
- **Accueil vivant** : carrousel photo animé (défilement automatique 2,5 s, effet « Ken Burns », légendes en cascade, parallaxe) et panneau « Choisissez votre niveau » superposé aux photos — liste verticale Licence 1 → Master 1 ; le niveau choisi révèle, centré et élargi, ses 4 rubriques (cours, TD, épreuves, œuvres)
